<template>
  <div class="app-input-frame">
    ...
    />
      <div
        class="app-input-area flex-no-wrap"
        :class="inputClass"
        :style="inputStyle"
      >
        <calendarPicker
        ...
        ></calendarPicker>
    <div class="time-display-area" v-if="time">
      <hourPicker
        ref="startHourPicker"
        :value="startDate"
...
export default {
  ...
  methods: {
    ...
    startDateEdge() {
       ...
       */
      if (
        moment(this.value.startDate).isValid() &&
        moment(this.value.endDate).isValid()
      ) {
        return (
          moment(this.value.startDate).isSameOrBefore(this.value.endDate) ||
          `日期不可大於迄日`
        );
      }
    ...
    endDateEdge() {
      ...
      if (
        ...
        return (
          moment(this.value.endDate).isSameOrAfter(this.value.startDate) ||
          `日期不可小於起日`
        );
      }
